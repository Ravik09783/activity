...
export class SignInRegisterComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder, private route: ActivatedRoute, private authService: AuthService, private dialogRef: MatDialogRef<any>, private dialog:MatDialog) { }
